...
#' @return Side effect is that selected iportant libraries are installed
#' @export clan.install
clan.install <- function(repos="http://cran.r-project.org",force=TRUE){
  print("Install important packages.")
  getOption("repos")

  install.packages("devtools",repos=repos,force=force)
  install.packages("roxygen2",repos=repos,force=force)
  install.packages("testthat",repos=repos,force=force)
  install.packages("knitr",repos=repos,force=force)
  
  install.packages("stringr",repos=repos,force=force)
  install.packages("dplyr",repos=repos,force=force)
  
  install.packages("gridBase",repos=repos,force=force)
  install.packages("gridExtra",repos=repos,force=force)
  install.packages("lattice",repos=repos,force=force)
  install.packages("latticeExtra",repos=repos,force=force)
  install.packages("ggplot2",repos=repos,force=force)

  install.packages("chron",repos=repos,force=force)
  install.packages("mgcv",repos=repos,force=force)
  install.packages("digest",repos=repos,force=force)
  install.packages("MASS",repos=repos,force=force)
  install.packages("tidyr",repos=repos,force=force)
  install.packages("jpeg",repos=repos,force=force)
  
  install_github("claus-e-andersen/clanTools",force=force)  
  install_github("claus-e-andersen/clanLattice",force=force)
  install_github("claus-e-andersen/clanOptim",force=force)
  install_github("claus-e-andersen/clanEgsnrc",force=force)
  install_github("claus-e-andersenclanMEView",force=force)
  }
